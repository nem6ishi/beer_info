...
def main():
    ...
    if args.command == "scrape":
        from backend.src.commands.scrape import scrape_to_supabase
        ...
        from backend.src.commands.update_stock import update_stock_status
        asyncio.run(update_stock_status(limit=args.limit, shop_filter=args.shop, sort_rating=args.sort_rating))

    elif args.command == "enrich":
        # Import commands
        from backend.src.commands.enrich_gemini import enrich_gemini
        from backend.src.commands.enrich_untappd import enrich_untappd
        from backend.src.commands.enrich_breweries import enrich_breweries
