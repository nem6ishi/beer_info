...
# Setup
supabase, logger = setup_script("manual_link_temporalis")

async def manual_link():
    target_url = "https://untappd.com/b/messorem-temporalis-0047/6500739"
    # Using the typo from the title to find it
    target_name_keyword = "%Temporlis #0047%" 
    
    print(f"🔗 Manually linking Temporalis #0047 to: {target_url}")
    ...
    for beer in beers:
        ...
        # Correcting spelling to Temporalis
        updates = {
            'untappd_url': target_url,
            'beer_name_en': "Temporalis #0047", 
