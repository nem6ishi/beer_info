...
# Setup
supabase, logger = setup_script("manual_link_obercreek")

async def manual_link():
    target_url = "https://untappd.com/b/messorem-found-dead-at-the-silo-2025/6517459"
    target_name_keyword = "%Obercreek Found Dead%"
    
    print(f"🔗 Manually linking Obercreek 2025 to: {target_url}")
    ...
    for beer in beers:
        ...
        # We update beer_name_en to include 2025 so future re-enrichements might respect it (or at least we persist the intent)
        updates = {
