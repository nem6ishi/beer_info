-- Migration: Add beer_name_core and search_hint to gemini_data
-- These fields are generated by Gemini and used to optimize Untappd search

ALTER TABLE gemini_data
  ADD COLUMN IF NOT EXISTS beer_name_core TEXT,
  ADD COLUMN IF NOT EXISTS search_hint TEXT;

-- Update beer_info_view to expose new fields
