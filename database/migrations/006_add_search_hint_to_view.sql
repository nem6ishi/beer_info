-- Migration 006: Add search_hint and beer_name_core to beer_info_view
-- These fields from gemini_data are used to optimize Untappd search

-- Step 1: Already done in migration 005 (ADD COLUMN to gemini_data)
-- But we need to recreate the view to include these new columns
